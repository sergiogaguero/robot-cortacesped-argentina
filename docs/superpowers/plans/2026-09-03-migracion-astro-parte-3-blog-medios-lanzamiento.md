...
7. `## Entonces, ¿conviene?` — cerrar con la cuenta: costo del robot ÷ lo que pagás por año = años de repago; ejemplo genérico "si pagás X por corte y cortás 30 veces, el robot se paga en Y años" expresado con letras (X, Y), y el argumento de tiempo: +168 horas libres por año. Última oración: invitar a chequear el modelo según metros y escribir por WhatsApp.
