import { ArrowRight, Zap, Wifi, MapPin, Shield } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {products.map((product) => (
            <a
              ...
              className="group relative bg-card border border-border rounded-2xl overflow-hidden hover:border-primary/50 transition-all duration-500 glow-border hover:animate-pulse-glow"
            >
